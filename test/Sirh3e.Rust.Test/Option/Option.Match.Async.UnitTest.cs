...
public partial class OptionUnitTest
{
    ...
    [Fact]
    public async Task Option_MatchAsync_Func_From_TSome_To_T_Func_To_T_Some()
    {
    ...
    [Fact]
    public async Task Option_MatchAsync_Func_From_TSome_To_T_Func_To_T_None()
    {
        var increasse = (string name) => name.Length;
        var decreasse = () => 0;
    ...
    [Fact]
    public async Task Option_MatchAsync_Func_From_TSome_To_ValueTask_T_Func_To_Task_T_Some()
    {
#if NET5_0_OR_GREATER
        var increasse = (string name) => ValueTask.FromResult(name.Length);
#else
        Func<string, ValueTask<int>> increasse = name => new(name.Length);
#endif
        var decreasse = () => Task.FromResult(0);
    ...
    [Fact]
    public async Task Option_MatchAsync_Func_From_TSome_To_ValueTask_T_Func_To_Task_T_None()
    {
#if NET5_0_OR_GREATER
        var increasse = (string name) => ValueTask.FromResult(name.Length);
#else
